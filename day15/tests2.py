...
class TestPerimeteredDiamond(unittest.TestCase):
    ...
    def test_remove_from_perimeter(t):
        ...
        cases = [
            ...
            [(5, 5, 4), [((1, 5), (1, 5))], [(1, 15)]],
            [(5, 5, 4), [((1, 5), (9, 5)), ((5, 9), (5, 9))], [(9, 15)]],
            [(5, 5, 4), [((9, 5), (2, 4)), ((5, 1), (5, 1))], [(0, 7)]]
        ]
...
class TestDiamondIntersectFinder(unittest.TestCase):
    ...
    def test_valid_returnsCorrectValidPoints(t):
        ...
        cases = [
            ...
            # ceil/floor required
            [(8, 8, 4), (4, 8, 3), ((5, 7), (5, 9))],
            [(8, 8, 4), (8, 12, 3), ((7, 11), (9, 11))],
            [(8, 8, 4), (12, 8, 3), ((11, 9), (11, 7))],
            [(8, 8, 4), (8, 4, 3), ((9, 5), (7, 5))],
            # not required
            [(8, 8, 4), (3, 8, 3), ((5, 7), (5, 9))],
            [(8, 8, 4), (8, 13, 3), ((7, 11), (9, 11))],
            [(8, 8, 4), (13, 8, 3), ((11, 9), (11, 7))],
            [(8, 8, 4), (8, 3, 3), ((9, 5), (7, 5))],
            # 1 corners, an intersect lands on a corner
            [(8, 8, 4), (5, 9, 3), ((5, 7), (6, 10))],
            [(8, 8, 4), (7, 11, 3), ((6, 10), (9, 11))],
            [(8, 8, 4), (9, 11, 3), ((7, 11), (10, 10))],
            [(8, 8, 4), (11, 9, 3), ((10, 10), (11, 7))],
            [(8, 8, 4), (11, 7, 3), ((11, 9), (10, 6))],
            [(8, 8, 4), (9, 5, 3), ((10, 6), (7, 5))],
            [(8, 8, 4), (7, 5, 3), ((9, 5), (6, 6))],
            [(8, 8, 4), (5, 7, 3), ((6, 6), (5, 9))],
            # 0 corners, intersects on opposite edges
            [(8, 8, 4), (6, 10, 5), ((6, 6), (10, 10))],
            [(8, 8, 4), (10, 6, 5), ((10, 10), (6, 6))],
            [(8, 8, 4), (6, 6, 5), ((10, 6), (6, 10))],
            [(8, 8, 4), (10, 10, 5), ((6, 10), (10, 6))],
            [(8, 8, 4), (6, 10, 3), ((5, 9), (7, 11))],
            [(8, 8, 4), (10, 10, 3), ((9, 11), (11, 9))],
            [(8, 8, 4), (10, 6, 3), ((11, 7),(9, 5))],
            [(8, 8, 4), (6, 6, 3), ((7, 5), (5, 7))],
            # 1 intersect = a corner
            [(8, 8, 4), (1, 8, 3), ((4, 8), (4, 8))],
            [(8, 8, 4), (8, 15, 3), ((8, 12), (8, 12))],
            [(8, 8, 4), (15, 8, 3), ((12, 8), (12, 8))],
            [(8, 8, 4), (8, 1, 3), ((8, 4), (8, 4))],
            # broken case from irl
            [(2, 18, 8), (14, 17, 5), ((10, 18), (9, 17))],
            [(2, 18, 8), (9, 16, 1), ((9, 17), (8, 16))]
        ]
        for i, (left, right, expected) in enumerate(cases):
            with t.subTest(f"case {i}: {cases[i]}"):
                left = t.diamond(*left)
                right = t.diamond(*right)
